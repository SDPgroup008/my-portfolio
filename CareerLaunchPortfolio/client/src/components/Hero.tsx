    ...
    >
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <h1 className="font-inter font-bold text-4xl md:text-5xl lg:text-6xl leading-tight mb-4 text-black">
              Building the <span className="text-black">digital future</span>, one line of code at a time
            </h1>
