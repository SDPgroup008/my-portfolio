        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              ...
              {/* Profile image from a stock photo source */}
              <div className="absolute inset-0 w-full h-full rounded-full border-4 border-white shadow-lg overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
